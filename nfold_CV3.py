...
train_Antigen, train_HLA, train_label = Antigen[CV_nfold_train[2]], HLA[CV_nfold_train[2]], label[CV_nfold_train[2]]
test_Antigen, test_HLA, test_label = Antigen[CV_nfold_test[2]], HLA[CV_nfold_test[2]], label[CV_nfold_test[2]]
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "DA3.pth")
