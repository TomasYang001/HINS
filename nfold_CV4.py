...
train_Antigen, train_HLA, train_label = Antigen[CV_nfold_train[3]], HLA[CV_nfold_train[3]], label[CV_nfold_train[3]]
test_Antigen, test_HLA, test_label = Antigen[CV_nfold_test[3]], HLA[CV_nfold_test[3]], label[CV_nfold_test[3]]
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "DA4.pth")
