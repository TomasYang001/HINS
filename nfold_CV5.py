...
train_Antigen, train_HLA, train_label = Antigen[CV_nfold_train[4]], HLA[CV_nfold_train[4]], label[CV_nfold_train[4]]
test_Antigen, test_HLA, test_label = Antigen[CV_nfold_test[4]], HLA[CV_nfold_test[4]], label[CV_nfold_test[4]]
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "DA5.pth")
