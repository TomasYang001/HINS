...
train_Antigen, train_HLA, train_label = Antigen[CV_nfold_train[1]], HLA[CV_nfold_train[1]], label[CV_nfold_train[1]]
test_Antigen, test_HLA, test_label = Antigen[CV_nfold_test[1]], HLA[CV_nfold_test[1]], label[CV_nfold_test[1]]
